...
public class AgentImmobilierResourceIntTest {
    ...
    public void createAgentImmobilier() throws Exception {
        ...
        assertThat(testAgentImmobilier.getIdUser()).isEqualTo(DEFAULT_ID_USER);
    }
    ...
    public void checkIdUserIsRequired() throws Exception {
        int databaseSizeBeforeTest = agentImmobilierRepository.findAll().size();
        // set the field null
        agentImmobilier.setIdUser(null);
    ...
    public void updateAgentImmobilier() throws Exception {
        ...
        assertThat(testAgentImmobilier.getIdUser()).isEqualTo(UPDATED_ID_USER);
    }
