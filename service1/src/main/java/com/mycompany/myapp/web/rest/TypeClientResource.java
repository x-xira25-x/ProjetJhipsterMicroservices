...
public class TypeClientResource {
    ...
    @Timed
    public ResponseEntity<TypeClient> createTypeClient(@RequestBody TypeClient typeClient) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<TypeClient> updateTypeClient(@RequestBody TypeClient typeClient) throws URISyntaxException {
