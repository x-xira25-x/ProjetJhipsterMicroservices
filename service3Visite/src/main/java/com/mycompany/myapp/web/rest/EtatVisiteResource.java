...
public class EtatVisiteResource {
    ...
    @Timed
    public ResponseEntity<EtatVisite> createEtatVisite(@RequestBody EtatVisite etatVisite) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<EtatVisite> updateEtatVisite(@RequestBody EtatVisite etatVisite) throws URISyntaxException {
