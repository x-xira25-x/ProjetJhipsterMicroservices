...
@EnableZuulProxy
public class AppliGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(AppliGatewayApp.class);

    private final Environment env;

    public AppliGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes AppliGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AppliGatewayApp.class);
