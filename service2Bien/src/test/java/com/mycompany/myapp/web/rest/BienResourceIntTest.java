...
import com.mycompany.myapp.Service2BienApp;
...
@SpringBootTest(classes = Service2BienApp.class)
public class BienResourceIntTest {
    ...
    public void createBien() throws Exception {
        ...
        assertThat(testBien.getIdClient()).isEqualTo(DEFAULT_ID_CLIENT);
    }
    ...
    public void updateBien() throws Exception {
        ...
        assertThat(testBien.getIdClient()).isEqualTo(UPDATED_ID_CLIENT);
    }
